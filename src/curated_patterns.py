...
PATTERNS: list[dict] = [
    {
        "id": "feb-accessory-promo",
        "title": "2 月飾品 / 頂級飾品促銷檔期",
        "anchor": {"month": 2, "day": 15, "flex_days": 21},   # Feb ± 3 weeks
        "kind": "recharge",
        "confidence": 0.85,
        "source": "站長觀察 (2026-05 加入)",
        "description": (
            "每年 2 月附近通常會有「飾品等級突破之術」開放升 飾品 等級上限；"
            "搭配此活動，儲值常贈送提升材料（八仙的祝福、鎮脈石、高級火雲覺醒石等）。"
            "此外，當週儲值排行榜前 5 名常獲贈「頂級飾品箱(自選)」這類稀有獎品。"
        ),
        "expected_signals": [
            "飾品等級突破", "品階洗煉", "頂級飾品", "絕世飾品",
            "八仙的祝福", "鎮脈石", "高級火雲覺醒石",
        ],
        "historical_evidence": [
            {"year": 2024, "article_id": 1483,
             "note": "2024-02-22 飾品等級突破之術 + 儲值滿 1000 送八仙的祝福、鎮脈石、高級火雲覺醒石"},
            {"year": 2025, "article_id": 1449,
             "note": "2025-12-18 飾品等級突破之術，跨期延續到 2026-02-15"},
        ],
    },
    # —— 之後新增的 pattern 寫在這裡 ——
]
